...
export default function DoctorantDashboard() {
  const publications = [
    { title: 'L\'impact de l\'IA sur l\'audit financier au Maroc', journal: 'Revue Marocaine de Gestion', date: 'Février 2026', status: 'PUBLISHED' },
    { title: 'Supply Chain Resilience post-crise', journal: 'International Journal of Logistics', date: 'En cours de révision', status: 'REVIEW' },
  ];

  const vacations = [
    { module: 'Introduction au Management (S1)', hours: '24h', date: 'Semestre 1', status: 'COMPLETED' },
    { module: 'Comptabilité Générale I (S2)', hours: '12h', date: 'Semestre 2', status: 'ONGOING' },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-white/5 relative overflow-hidden">
            ...
            <div className="text-sm font-bold text-blue-600 mb-6">"Digitalisation et Performance des PME Marocaines"</div>

            <div className="space-y-6 relative z-10">
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-bold text-white/80">Progression Globale Estimée</span>
                  <span className="text-sm font-black text-[#003a8c]">45%</span>
                </div>
                <div className="h-3 w-full bg-white/[0.05] rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full" style={{ width: '45%' }}></div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="border border-white/10 rounded-xl p-4 bg-white/[0.02]">
                  ...
                  <div className="font-bold text-white">Prof. Alaoui, M.</div>
                </div>
                <div className="border border-white/10 rounded-xl p-4 bg-white/[0.02]">
                  <div className="text-xs font-bold text-white/50 uppercase mb-1">Prochaine Échéance</div>
                  <div className="font-bold text-rose-600 flex items-center gap-1"><Clock className="w-4 h-4" /> Dépôt Rapport (15 Juin)</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-center py-4">
              <div className="relative w-32 h-32">
                <svg className="w-full h-full transform -rotate-90">
                  ...
                  <circle cx="64" cy="64" r="56" className="stroke-purple-500" strokeWidth="12" fill="none" strokeDasharray="351.858" strokeDashoffset={351.858 * (1 - 120/200)} />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-2xl font-black text-white">120h</span>
                  <span className="text-[10px] font-bold text-white/50 uppercase">/ 200h req.</span>
                </div>
              </div>
            </div>
          </div>
