...
export default function ProfessorWorkloadPage() {
  ...
  // Default fallback data for permanent professors (100% pedagogical, no financial metrics)
  const defaultPermanent = {
    ...
    weekly_schedule_summary: [
      { day: 'Lundi', time: '08:30 – 10:30', module: 'Économie Générale II', group: 'TC-S2-G1', room: 'Salle 101', type: 'CM' },
      { day: 'Mardi', time: '10:45 – 12:45', module: 'Finance d\'Entreprise', group: 'GFC-S5-G1', room: 'Salle 102', type: 'CM' },
      { day: 'Mercredi', time: '14:30 – 16:30', module: 'Économie Générale II', group: 'TC-S2-G2', room: 'Salle 101', type: 'TD' },
      { day: 'Jeudi', time: '08:30 – 10:30', module: 'Études de Marché', group: 'MCM-S5-G1', room: 'Salle 101', type: 'CM' },
      { day: 'Vendredi', time: '10:45 – 12:45', module: 'Finance d\'Entreprise', group: 'GFC-S5-G2', room: 'Salle 102', type: 'TD' },
      { day: 'Samedi', time: '08:30 – 10:30', module: 'Études de Marché', group: 'MCM-S5-G1', room: 'Lab Info 1', type: 'TP' },
    ],
    monthly_breakdown: [
      { month: 'Octobre', cm: 24, td: 12, tp: 4, total: 40, sessions: 20, status: 'Certifié Conforme' },
      { month: 'Novembre', cm: 32, td: 16, tp: 4, total: 52, sessions: 26, status: 'Certifié Conforme' },
      { month: 'Décembre', cm: 24, td: 12, tp: 4, total: 40, sessions: 20, status: 'Certifié Conforme' },
      { month: 'Janvier', cm: 16, td: 8, tp: 4, total: 28, sessions: 14, status: 'En cours d\'émargement' },
    ],
    modules_breakdown: [
      { code: 'M-ECO2', name: 'Économie Générale II', filiere: 'Tronc Commun (TC-S2)', type: 'CM + TD', cm: 48, td: 24, tp: 0, total: 72, sessions: 36, progress: 85 },
      { code: 'M-FIN1', name: 'Finance d\'Entreprise', filiere: 'Gestion Financière (GFC-S5)', type: 'CM + TD', cm: 32, td: 16, tp: 0, total: 48, sessions: 24, progress: 80 },
      { code: 'M-MKT3', name: 'Études de Marché', filiere: 'Marketing & Commerce (MCM-S5)', type: 'CM + TP', cm: 16, td: 8, tp: 16, total: 40, sessions: 20, progress: 90 },
    ]
  };

  // Default fallback data for vacataires (hourly rate, payouts, virement)
  const defaultVacataire = {
    is_vacataire: true,
    contract_ref: 'CONTRAT-VAC-2026-ENCG-042',
    hours_done: 64,
    hours_cm: 40,
    hours_td: 24,
    hours_tp: 0,
    ...
    total_sessions: 32,
    hourly_rate: 350,
    estimated_payment: 22400,
    virement_status: 'Bordereau Validé par la Direction — En cours d\'Ordonnancement Trésorerie',
    virement_step: 3,
    monthly_breakdown: [
      { month: 'Octobre', cm: 16, td: 8, tp: 0, total: 24, amount: 8400, status: 'Certifié Payé' },
      { month: 'Novembre', cm: 16, td: 8, tp: 0, total: 24, amount: 8400, status: 'Certifié Payé' },
      { month: 'Décembre', cm: 8, td: 8, tp: 0, total: 16, amount: 5600, status: 'Mandaté en Trésorerie' },
    ]
  };

  const w = isVacataire 
    ? (workloadData?.is_vacataire ? workloadData : defaultVacataire) 
    : (workloadData?.is_vacataire ? defaultPermanent : (workloadData || defaultPermanent));
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-baseline text-sm font-black">
                <span className="text-slate-800 dark:text-white">
                  Heures Enseignées Réalisées : <strong className="text-blue-600 dark:text-blue-400 text-lg">{w.hours_done}h</strong>
                </span>
                <span className="text-slate-500 font-mono text-xs">
                  Objectif Statutaire Annuel : <strong>{w.statutory_hours}h</strong> ({w.remaining_hours}h restantes)
                </span>
              </div>
              ...
              <div className="flex justify-between text-xs font-bold text-slate-500 pt-1">
                <span>Cours Magistraux (CM) : <strong className="text-slate-800 dark:text-white">{w.hours_cm}h</strong></span>
                <span>Travaux Dirigés (TD) : <strong className="text-slate-800 dark:text-white">{w.hours_td}h</strong></span>
                <span>Travaux Pratiques (TP) : <strong className="text-slate-800 dark:text-white">{w.hours_tp}h</strong></span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-black text-slate-900 dark:text-white">{w.weekly_hours} Heures / sem.</div>
                <div className="text-[11px] font-bold text-blue-600 dark:text-blue-400">6 séances de 2h par semaine</div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400">{w.total_sessions} Séances</div>
                <div className="text-[11px] font-bold text-emerald-700 dark:text-emerald-400">100% validées et publiées</div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-black text-indigo-600 dark:text-indigo-400">{w.syllabus_progress}% Réalisé</div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs font-black text-slate-900 dark:text-white leading-snug">Validé Chef Département</div>
                <div className="text-[11px] font-bold text-teal-600 dark:text-teal-400">Dossier en règle pour avancement</div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6 animate-in fade-in duration-300">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-5 rounded-2xl bg-blue-50/50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/40 space-y-2">
                    ...
                    <div className="text-2xl font-black text-slate-900 dark:text-white">{w.hours_cm}h <span className="text-xs font-normal text-slate-500">/ 48 séances</span></div>
                  ...
                  <div className="p-5 rounded-2xl bg-indigo-50/50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/40 space-y-2">
                    ...
                    <div className="text-2xl font-black text-slate-900 dark:text-white">{w.hours_td}h <span className="text-xs font-normal text-slate-500">/ 24 séances</span></div>
                  ...
                  <div className="p-5 rounded-2xl bg-emerald-50/50 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/40 space-y-2">
                    ...
                    <div className="text-2xl font-black text-slate-900 dark:text-white">{w.hours_tp}h <span className="text-xs font-normal text-slate-500">/ 8 séances</span></div>
                ...
                <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/60 flex items-center justify-between">
                  ...
                  <button 
                    onClick={handleDownloadWorkloadPdf}
                    className="text-xs font-black text-blue-600 dark:text-blue-400 hover:underline shrink-0"
                  >
                    Télécharger PDF →
                  </button>
                </div>
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-xs font-bold">
                    {w.monthly_breakdown?.map((row: any, idx: number) => (
                      <tr key={idx} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                        ...
                        <td className="py-4 text-center text-slate-700 dark:text-slate-300">{row.sessions || Math.round(row.total / 2)} séances</td>
                  ...
                  {w.weekly_schedule_summary?.map((slot: any, idx: number) => (
                    <div key={idx} className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 flex flex-col justify-between space-y-3">
                      ...
                      <div className="pt-2 border-t border-slate-200 dark:border-slate-700/50 flex items-center justify-between text-[11px]">
                        ...
                        <span className="text-emerald-600 dark:text-emerald-400 font-black">2h certifiées</span>
                      </div>
                    </div>
                  ))}
                </div>
                  ...
                  <div key={idx} className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      ...
                      <div className="text-right">
                        <div className="text-lg font-black text-blue-600 dark:text-blue-400">{mod.total}h <span className="text-xs text-slate-400">({mod.sessions} séances)</span></div>
        ...
        <>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200 dark:border-slate-800 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-baseline text-sm font-black">
                <span className="text-slate-800 dark:text-white">
                  Heures Effectuées & Facturables : <strong className="text-amber-600 dark:text-amber-400 text-lg">{w.hours_done}h</strong>
                </span>
                <span className="text-slate-500 font-mono text-xs">
                  Paiement horaire à la vacation : <strong>{w.hourly_rate} MAD / heure</strong>
                </span>
              </div>
              ...
              <div className="flex justify-between text-xs font-bold text-slate-500 pt-1">
                ...
                <span>Total Séances : <strong className="text-slate-800 dark:text-white">{w.total_sessions} séances</strong></span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-black text-slate-900 dark:text-white">{w.hours_done} Heures</div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-800 flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-black text-emerald-600 dark:text-emerald-400">
                  {w.estimated_payment ? w.estimated_payment.toLocaleString() : (w.hours_done * w.hourly_rate).toLocaleString()} MAD
                </div>
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-xs font-bold">
                  {w.monthly_breakdown?.map((row: any, idx: number) => (
                    <tr key={idx} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="py-4 text-center text-slate-700 dark:text-slate-300">{row.cm}h</td>
                      <td className="py-4 text-center text-slate-700 dark:text-slate-300">{row.td}h</td>
                      <td className="py-4 text-center font-mono font-black text-slate-900 dark:text-white">{row.total}h</td>
                      <td className="py-4 text-center text-slate-500">{w.hourly_rate} MAD</td>
                      <td className="py-4 text-center text-emerald-600 dark:text-emerald-400 font-black">
                        {(row.amount || row.total * w.hourly_rate).toLocaleString()} MAD
                      </td>
                      <td className="py-4 text-right pr-2">
                        <span className={cn(
                          "px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider",
