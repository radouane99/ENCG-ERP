  ...
  return (
    <div className="h-[calc(100vh-80px)] p-4 md:p-6 max-w-[1400px] mx-auto animate-in flex flex-col">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
        <div>
          <h1 className="text-3xl font-bold text-[hsl(var(--foreground))]">{isRtl ? 'القسم الرقمي' : 'Espace Classroom'}</h1>
          <p className="text-[hsl(var(--muted-foreground))] mt-1 font-medium text-sm">Management Stratégique (M12) • S6 • Amphi 1</p>
        </div>
        <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-full p-1.5 flex shadow-sm">
          <button
            onClick={() => setActiveTab('attendance')}
            className={cn("flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-bold transition-all", activeTab === 'attendance' ? "bg-[hsl(var(--color-primary))] text-white shadow-md" : "text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))]")}
          >
      ...
      <div className="flex-1 overflow-hidden relative">
        ...
        {activeTab === 'attendance' && (
          <div className="h-full flex flex-col lg:flex-row gap-6 animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="flex-1 bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-3xl p-10 flex flex-col items-center justify-center shadow-lg relative overflow-hidden">
              <div className="absolute top-0 end-0 p-8 opacity-5 text-[hsl(var(--color-primary))]">
                <QrCode size={200} />
              </div>
            ...
            <div className="w-full lg:w-96 bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-3xl flex flex-col overflow-hidden shadow-lg">
              <div className="p-6 border-b border-[hsl(var(--border))] bg-[hsl(var(--muted)/30)]">
                ...
                <div className="mt-4 flex items-end gap-2">
                  ...
                  <span className="text-[hsl(var(--muted-foreground))] font-medium pb-1">/ 50 inscrits</span>
                </div>
              </div>
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="flex items-center gap-3 p-3 bg-[hsl(var(--background))] rounded-2xl border border-[hsl(var(--border))] animate-in fade-in slide-in-from-bottom-2">
                    <div className="w-10 h-10 bg-[hsl(var(--color-primary))/10] rounded-full flex items-center justify-center text-[hsl(var(--color-primary))] font-bold text-sm">
                      E{i}
                    </div>
                    <div className="flex-1">
                      <p className="text-sm font-bold text-[hsl(var(--foreground))]">Étudiant {i}</p>
                      <p className="text-xs text-[hsl(var(--muted-foreground))]">Présent à 08:3{i}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {/* AI Tab */}
        {activeTab === 'ai' && (
          <div className="h-full bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-3xl shadow-lg flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-300">
            <div className="p-6 border-b border-[hsl(var(--border))] bg-gradient-to-r from-purple-900 to-[#14285e] text-white flex items-center justify-between">
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-6 bg-[hsl(var(--background))]">
              {/* AI Chat Bubbles Mock */}
              <div className="flex gap-4">
                <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center shrink-0">
                  <BrainCircuit className="w-5 h-5 text-purple-600" />
                </div>
                <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] p-4 rounded-2xl rounded-tl-sm max-w-2xl shadow-sm">
              ...
              <div className="flex gap-4 flex-row-reverse">
                <div className="w-10 h-10 bg-[hsl(var(--color-primary))] rounded-full flex items-center justify-center shrink-0 text-white font-bold text-sm">
                  PR
                </div>
                <div className="bg-[hsl(var(--color-primary))] text-white p-4 rounded-2xl rounded-tr-sm max-w-2xl shadow-sm">
              ...
              <div className="flex gap-4">
                ...
                <div className="bg-[hsl(var(--card))] border border-[hsl(var(--border))] p-6 rounded-2xl rounded-tl-sm max-w-2xl shadow-sm w-full">
                  <p className="text-[hsl(var(--foreground))] font-bold mb-4 text-sm">{isRtl ? 'إليك مقترح QCM:' : 'Voici une proposition de QCM :'}</p>
                  <div className="space-y-4">
                    <div className="p-4 bg-[hsl(var(--muted)/50)] rounded-xl border border-[hsl(var(--border))]">
                      <p className="font-bold text-sm text-[hsl(var(--foreground))] mb-2">1. Quel est l'objectif principal du bilan fonctionnel ?</p>
            ...
            <div className="p-4 bg-[hsl(var(--card))] border-t border-[hsl(var(--border))]">
              <div className="relative flex items-center bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-full p-1.5 focus-within:ring-2 focus-within:ring-purple-500/20 focus-within:border-purple-500 transition-all shadow-inner">
                <button className="p-3 text-[hsl(var(--muted-foreground))] hover:text-purple-600 transition-colors">
                  <Mic size={20} />
                </button>
                <input 
                  type="text" 
