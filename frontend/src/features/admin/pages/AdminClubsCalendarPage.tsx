...
export default function AdminClubsCalendarPage() {
  return (
    <div className="space-y-6 animate-in p-6 max-w-7xl mx-auto pb-20">
      <div className="flex items-center justify-center mb-12 relative">
        ...
        <div className="flex flex-col items-center">
          <div className="flex items-center gap-3 mb-1">
            <Calendar className="w-6 h-6 text-[#0f2863]" />
            <h1 className="text-xl font-bold text-[#0f2863] italic">Calendrier des Salles — Clubs</h1>
          </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-16 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-sm font-bold text-slate-700 mb-2">Aucun événement planifié</h3>
        <p className="text-xs text-slate-400">Le calendrier des réservations apparaîtra ici.</p>
      </div>
    </div>
  )
}
