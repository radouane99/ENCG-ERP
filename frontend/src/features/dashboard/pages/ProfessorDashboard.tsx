  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Espace Professeur ðŸ‘‹</h1>
          <p className="text-white/40 text-sm mt-0.5">Bienvenue, Prof. {user?.name}</p>
        </div>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-2xl bg-white/5 border border-white/10 p-5 relative overflow-hidden">
          <p className="text-white/50 text-xs font-medium uppercase">Modules Assignés</p>
          <p className="text-3xl font-bold text-white mt-1">{stats?.modules_taught}</p>
          <BookOpen className="absolute right-[-10px] bottom-[-10px] text-blue-500/10" size={80} />
        </div>
        <div className="rounded-2xl bg-white/5 border border-white/10 p-5 relative overflow-hidden">
          <p className="text-white/50 text-xs font-medium uppercase">Étudiants</p>
        ...
        <div className="rounded-2xl bg-white/5 border border-white/10 p-5 relative overflow-hidden">
          <p className="text-white/50 text-xs font-medium uppercase">Notes en attente</p>
        ...
        <div className="rounded-2xl bg-white/5 border border-white/10 p-5 relative overflow-hidden">
          <p className="text-white/50 text-xs font-medium uppercase">Séances Validées</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="rounded-2xl bg-white/5 border border-white/10 p-5">
          <h3 className="text-white font-semibold mb-4">Assiduité par Module</h3>
        ...
        <div className="rounded-2xl bg-white/5 border border-white/10 p-5">
          <h3 className="text-white font-semibold mb-4">Prochain Cours</h3>
          {stats?.next_class && (
            <div className="bg-white/5 rounded-xl p-4 border border-white/5">
              ...
              <p className="text-lg font-bold text-white">{stats.next_class.module}</p>
              <p className="text-white/50 text-sm mt-1">Salle: {stats.next_class.room}</p>
            </div>
          )}
        </div>
      </div>
