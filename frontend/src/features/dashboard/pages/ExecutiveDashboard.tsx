    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-white/50 mt-1">Vue d'ensemble stratégique de l'institution.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-primary to-[#7D0809] rounded-3xl p-6 text-white shadow-xl shadow-primary/20">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-white/60 text-xs font-bold uppercase tracking-widest mb-1">Total Étudiants</p>
        ...
        <div className="bg-card border border-white/10 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-white/50 text-xs font-bold uppercase tracking-widest mb-1">Taux de Réussite</p>
        ...
        <div className="lg:col-span-2 bg-card border border-white/10 rounded-3xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xs text-white/50">Taux de diplômés en poste après 6 mois</p>
            </div>
          ...
          <div className="bg-card border border-white/10 rounded-3xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-white/5/50 rounded-2xl border border-white/10/50">
                <p className="text-xs text-white/50 uppercase tracking-widest font-bold mb-1">Coût des Vacations</p>
