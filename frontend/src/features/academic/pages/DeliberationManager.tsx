          ...
          <div className="bg-card border border-border rounded-2xl p-5 shadow-sm">
            ...
            <div className="bg-muted/30 border border-border/50 rounded-xl p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-md mx-auto mb-6">
                Le moteur va calculer les moyennes (CC 50% + Examen 50%), appliquer les zéros éliminatoires pour absences, plafonner les notes de rattrapage à 10, et calculer les compensations semestrielles.
              </p>
              <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-muted/50 p-4 rounded-xl border border-border/50">
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <p className="text-xs text-amber-500 mt-2 flex items-center gap-1"><AlertTriangle className="w-3 h-3" /> Plafonné à 10 (MIN(10, MAX(CC, Rattrapage)))</p>
                    </div>
                  </div>

                  <div className="bg-muted/50 p-4 rounded-xl border border-border/50">
                    <p className="text-xs font-bold uppercase text-muted-foreground mb-2 tracking-wider">Règle de Progression (1A → 2A)</p>
                    <div className="text-sm space-y-1">
