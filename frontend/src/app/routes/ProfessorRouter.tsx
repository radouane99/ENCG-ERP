...
const ProfessorStudentRosterPage = lazy(() => import('@features/professor-portal/pages/ProfessorStudentRosterPage'))
...
export default function ProfessorRouter() {
  ...
  return (
    <Routes>
      <Route path="schedule" element={<ProfessorTimetablePage />} />
      <Route path="schedules" element={<ProfessorTimetablePage />} />
      ...
      <Route path="rooms/availability" element={<RoomAvailabilityHubPage />} />
      ...
      <Route path="student-rosters" element={<ProfessorStudentRosterPage />} />
    </Routes>
  );
}
