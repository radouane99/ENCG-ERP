...
const navigation: (NavItem | NavGroup)[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Candidatures & Admission', href: '/admissions/candidatures', icon: InboxIcon, roles: ['super-admin', 'institution-admin', 'director'] },
      ...
      { label: 'Crédits & Dérogations', href: '/admin/students-credits', icon: Award, roles: ['super-admin', 'institution-admin', 'director'] },
      ...
      { label: 'Conseil de Discipline', href: '/discipline', icon: ShieldAlert, roles: ['super-admin', 'institution-admin', 'director'] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Cours & E-Learning (LMS)', href: '/lms/courses', icon: BookOpen, roles: ['super-admin', 'institution-admin', 'director', 'professor', 'student'] },
      { label: 'Bibliothèque & Emprunts', href: '/library', icon: Library, roles: ['super-admin', 'institution-admin', 'director', 'professor', 'student'] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Évaluations & Enquêtes', href: '/admin/evaluations', icon: CheckSquare, roles: ['super-admin', 'institution-admin'] },
      { label: 'Workflow Builder', href: '/admin/workflow-builder', icon: Kanban, roles: ['super-admin', 'institution-admin'] },
