...
Route::middleware(['auth:sanctum', 'role:admin|super-admin|super_admin|institution-admin|institution_admin|director|department-head|filiere-head|professor|vacataire|finance-officer|hr-officer|library-manager|discipline-committee'])->group(function () {
    ...
    Route::prefix('exam-planning')->group(function () {
        ...
        Route::match(['post', 'delete'], '/reset', [ExamPlanningController::class, 'resetExams']);
        ...
        Route::post('/{examId}/save-signature', [ConvocationController::class, 'saveExamSignature']);
    ...
    Route::post('/admin/professor-document-requests/{id}/correct-dates', [AdminDocumentRequestController::class, 'correctDates']);
...
Route::middleware(['auth:sanctum', $staffRoles])->group(function () {
    ...
    Route::get('/admin/privacy/requests', [PrivacyController::class, 'adminIndex']);
    Route::patch('/admin/privacy/requests/{id}/status', [PrivacyController::class, 'adminUpdateStatus']);
    Route::post('/students/{student}/biometric-match', [StudentController::class, 'runBiometricMatch']);
