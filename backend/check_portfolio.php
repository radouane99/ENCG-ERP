...
$student = App\Models\User::where('email', 'student@encg-fes.ma')->first()?->student;

echo "=== REGISTRATIONS ===" . PHP_EOL;
$regs = App\Models\StudentRegistration::with(['filiere', 'academicYear', 'group'])->where('student_id', $student->id)->get();
...
$pathways = App\Models\StudentPathway::where('student_id', $student->id)->get();
...
echo "=== GRADES ===" . PHP_EOL;
$grades = App\Models\Grade::with('module')->where('student_id', $student->id)->get();
