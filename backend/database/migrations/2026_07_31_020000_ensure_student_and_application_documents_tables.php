...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('applications', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('applications', 'family_status')) {
            ...
            if (! Schema::hasColumn('applications', 'father_name_ar')) {
            ...
            if (! Schema::hasColumn('applications', 'mother_name_ar')) {
        ...
        Schema::table('students', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('students', 'birth_city')) {
                $table->string('birth_city')->nullable();
            }
            ...
            if (! Schema::hasColumn('students', 'family_status')) {
                $table->string('family_status')->nullable();
            }
            ...
            if (! Schema::hasColumn('students', 'father_name_ar')) {
                $table->string('father_name_ar')->nullable();
            }
            ...
            if (! Schema::hasColumn('students', 'mother_name_ar')) {
                $table->string('mother_name_ar')->nullable();
            }
