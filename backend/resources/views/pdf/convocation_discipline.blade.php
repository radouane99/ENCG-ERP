...
<div class="page-container">
        ...
        <tr>
            ...
            <td style="width: 25%; text-align: right;">
                <table class="ref-badge-table">
                    ...
                    <tr>
                        <td class="ref-code" colspan="2">ENCG/CD-2026/{{ str_pad($incident->id ?? 1, 4, '0', STR_PAD_LEFT) }}</td>
                    </tr>
                    <tr>
    ...
    <!-- Fiche d'Identification du Candidat Convoqué -->
    ...
    <div class="section-box">
        ...
        <table class="section-table">
            <tr>
                ...
                <td class="val-col">
                    <strong>{{ $moduleName ?? 'Épreuve Semestrielle' }}</strong> &nbsp;
                    <span style="font-weight: normal; color: #64748b; font-size: 6.8pt;">(Session d'examen du {{ $examDate ?? date('d/m/Y') }})</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="val-col">
                    <span class="pill-scelle">SCELLÉ N° CD-{{ str_pad($incident->id ?? 1, 4, '0', STR_PAD_LEFT) }}</span> &nbsp;
                    <strong style="color: #854d0e;">{{ $incident->confiscated_items }}</strong> &nbsp;
    ...
    <!-- Section 2 : Convocation Solennelle à l'Audience Contradictoire -->
        ...
        <table class="hearing-grid-table">
            <tr>
                <td class="hearing-grid-cell" style="width: 35%;">
                    ...
                    <span class="hearing-metric-val">{{ $hearingDate }}</span>
                </td>
                <td class="hearing-grid-cell" style="width: 37%;">
                    <span class="hearing-metric-lbl">LIEU DE RÉUNION</span>
                    <span class="hearing-metric-val">{{ $hearingRoom }}</span>
                </td>
    ...
    <!-- Section 3 : Droits du Candidat & Garanties Procédurales -->
    <div class="legal-box">
        ...
        <tr>
            ...
            <td style="width: 90%; padding-left: 6px;">
                <div class="hash-code">
                    ...
                    {{ $sealHash ?? hash('sha256', 'ENCG-DISCIPLINE-'.($incident->id ?? 1)) }}<br>
